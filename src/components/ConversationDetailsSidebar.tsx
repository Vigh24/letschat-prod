    ...
    <div className="flex flex-col items-center px-5 py-6 text-center">
      <div className="relative mb-3">
        ...
        {contact?.whatsapp_number && (
          <div className="absolute -bottom-0.5 -right-0.5 h-4 w-4 rounded-full bg-emerald-500 border-2 border-white dark:border-zinc-900 flex items-center justify-center">
      ...
      <h4 className="text-sm font-bold text-slate-800 dark:text-zinc-100">{name}</h4>
      <div className="flex items-center gap-1.5 mt-1">
        <TierLabel tier={tier} />
        <StatusLabel status={conv.status} />
      </div>
      {contact?.whatsapp_number && (
        <div className="flex items-center gap-1.5 mt-2.5 text-[11px] text-slate-500 dark:text-zinc-400 font-mono select-all">
          <Smartphone className="h-3 w-3 text-emerald-500" />
          {contact.whatsapp_number}
        </div>
      )}
      {contact?.email && (
        <div className="flex items-center gap-1.5 mt-1 text-[11px] text-slate-500 dark:text-zinc-400 select-all">
      ...
      {onMakeCall && contact?.whatsapp_number && (
        <button
          ...
          className="mt-3 flex items-center gap-1.5 rounded-lg border border-slate-200 dark:border-white/[0.08] px-3 py-1.5 text-[10px] font-semibold text-slate-600 dark:text-zinc-300 hover:bg-slate-50 dark:hover:bg-white/[0.03] transition-colors cursor-pointer"
        >
